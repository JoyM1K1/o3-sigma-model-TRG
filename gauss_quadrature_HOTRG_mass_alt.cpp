...
void
Trace(const int n_data_point_start, const int n_data_point_end, double const K, MKL_INT const D_cut, MKL_INT const n_node, MKL_INT const N, std::ofstream &file) {
    time_counter time;
    ...
    HOTRG::ImpureTensor leftIMT(D, D_cut);
    HOTRG::ImpureTensor rightIMT(D, D_cut);
...
int main(int argc, char *argv[]) {
    ...
    const string dir = "gauss_quadrature_HOTRG_mass_alt";
    time_counter time;
    string fileName;
